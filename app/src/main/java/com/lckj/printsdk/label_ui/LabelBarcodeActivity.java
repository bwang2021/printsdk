...
public class LabelBarcodeActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener, PrintUtil.PrinterBinderListener {
    ...
    private String barContent="HC1640052892153-10";
...
//            printUtil.printConcentration (concentration);
            if ("1".equals (mPageType)) {
                ...
                printUtil.setFeedPaperSpace (1000);
                printUtil.setUnwindPaperLen (return_distance);

            }
            printUtil.printBarcode (PrintConfig.Align.ALIGN_CENTER, 80, barContent, mBarcode1DType, PrintConfig.HRIPosition.POSITION_NONE);
            printUtil.printText (PrintConfig.Align.ALIGN_CENTER, PrintConfig.FontSize.TOP_FONT_SIZE_SMALL, false, false, "\n");
            printUtil.printText (PrintConfig.Align.ALIGN_CENTER, PrintConfig.FontSize.TOP_FONT_SIZE_MIDDLE, false, false, "咽拭子  12345684886466");
